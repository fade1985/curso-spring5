...
import com.atmira.springboot.app.models.dao.IUsuarioDao;
import com.atmira.springboot.app.models.entity.Role;
import com.atmira.springboot.app.models.entity.Usuario;
    ...
    public UserDetails loadUserByUsername(
        ...
        if (authorities.isEmpty()) {
            ...
            throw new UsernameNotFoundException(
                    "Error login: usuario '".concat(username).concat("' no tiene roles asignado!"));
        }
        return new User(usuario
                .getUsername(), usuario.getPassword(), usuario.getEnabled(), true, true, true, authorities);
    }
